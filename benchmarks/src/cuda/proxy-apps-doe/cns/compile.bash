...
nvcc -gencode=arch=compute_20,code=\"sm_20,compute_20\" -gencode=arch=compute_61,code=\"sm_60,compute_61\" -Xptxas -v,-abi=no prototype_simple.cu $FLAGS -o cns_all -lcudart
