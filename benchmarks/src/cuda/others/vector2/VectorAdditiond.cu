...
// Host code
void VectorAddition(int N, int threadsPerBlock, int compute)
{
	...
	cout<<"deviceIndex"<<deviceIndex<<", SM = "<<deviceProperties.major<<"."<<deviceProperties.minor<<endl;// "L1 cache: " <<deviceProperties.globalL1CacheSupported<<endl;
